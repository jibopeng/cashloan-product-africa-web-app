...
public class UserEquipmentInfoServiceImpl extends BaseServiceImpl<UserEquipmentInfo, Long> implements UserEquipmentInfoService {
	...
	public int saveOrUpdate(UserEquipmentInfo uei) {
		...
		map.put("androidId", uei.getAndroidId());
		map.put("gpsadId", uei.getGpsadId());
	...
	@Override
	public int findRegisterSameImei(String imei) {
		return userEquipmentInfoMapper.findRegisterSameImei(imei);
	}
