 ...
 * 
 * 复贷还款表现展示类
 * CREATE TABLE `cl_report_old_loan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `loan_time` varchar(255) DEFAULT NULL COMMENT '应还款时间',
  `repay_time` varchar(255) DEFAULT NULL,
  `loan_num` varchar(255) DEFAULT NULL COMMENT '应还款数',
  `repaid_num` varchar(255) DEFAULT NULL COMMENT '已还款数',
  `overdue_num` varchar(255) DEFAULT NULL COMMENT '逾期数',
  `overdue per` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8mb4 COMMENT='复贷运营分析表';


 *
 */
public class OldLoanRepPerModel {
